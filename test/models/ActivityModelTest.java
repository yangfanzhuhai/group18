...
public class ActivityModelTest {
	...
	public void testToJson() {
		...
		activityModel.setActor(mockActor);
		activityModel.setPublished(PUBLISHED_DATE);
		activityModel.setObject(mockObject);
		activityModel.setTarget(mockTarget);
		activityModel.setVerb(VERB_STRING);

		String expectedJSON = "{\"published\" : \"" + PUBLISHED_DATE
				+ "\", \"actor\" : " + ACTOR_JSON + ", \"verb\" : \""
				+ VERB_STRING + "\", \"object\" : " + OBJECT_JSON
				+ ", \"target\" : " + TARGET_JSON + " }";
